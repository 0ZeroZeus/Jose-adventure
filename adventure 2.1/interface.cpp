...
void exibe_jose(jogador jose){
	...
	printf("Arma\n%s\nBonus de vida: %d\nBonus de armadura: %d\nBonus de dano: %d\nBonus de dano magico: %d\n\n",jose.gear[0].nome, jose.gear[0].vida, jose.gear[0].armor, jose.gear[0].dano, jose.gear[0].dano_magico);
	printf("Acessorio de cabeca\n%s\nBonus de vida: %d\nBonus de armadura: %d\nBonus de dano: %d\nBonus de dano magico: %d\n\n",jose.gear[1].nome, jose.gear[1].vida, jose.gear[1].armor, jose.gear[1].dano, jose.gear[1].dano_magico);
	printf("Peca de Torax\n%s\nBonus de vida: %d\nBonus de armadura: %d\nBonus de dano: %d\nBonus de dano magico: %d\n\n",jose.gear[2].nome, jose.gear[2].vida, jose.gear[2].armor, jose.gear[2].dano, jose.gear[2].dano_magico);
	printf("Peca das pernas\n%s\nBonus de vida: %d\nBonus de armadura: %d\nBonus de dano: %d\nBonus de dano magico: %d\n\n",jose.gear[3].nome, jose.gear[3].vida, jose.gear[3].armor, jose.gear[3].dano, jose.gear[3].dano_magico);
	printf("Sapato\n%s\nBonus de vida: %d\nBonus de armadura: %d\nBonus de dano: %d\nBonus de dano magico: %d\n\n",jose.gear[4].nome, jose.gear[4].vida, jose.gear[4].armor, jose.gear[4].dano, jose.gear[4].dano_magico);
	getchar();
	fclose(status);
